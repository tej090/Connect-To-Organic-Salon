...
<nav class="navbar navbar-dark bg-success">
  <div class="container-fluid">
    <div class="navbar-header">
      <img src="/image/logo.png" width="70" height="70" alt="Bootstrappin"/>
      <img src="/image/logo2.jpg" width="70" height="70" alt="Bootstrappin"/>
    </div>
     <div class="navbar-header">
      <a class="navbar-brand" > &nbsp&nbsp&nbsp Connect To Organic Salon
  ...
  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
         <img src="/image/Home17.png" alt="Los Angeles" style="width:100%;">
      ...
      <div class="item">
        <img src="/image/fp7.jpg" alt="Chicago" style="width:100%;">
         <div class="carousel-caption">
      ...
      <div class="item">
        <img src="/image/fp8.jpg" alt="New york" style="width:100%;">
         <div class="carousel-caption">
