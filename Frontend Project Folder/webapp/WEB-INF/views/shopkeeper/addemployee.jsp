...
<sf:form method="post" modelAttribute="employees">
		<table border="1" class="table table-striped table-bordered" style="width:50%">
					...
					<tr>
						<td><b>Enter Employee Mob No</b></td>
						<td><input type="text" name="empMobNo" /></td>
					</tr>

					<tr>
						<td><b>Enter Employee Experience</b></td>
						<td><input type="text" name="empExperience" /></td>
					</tr>
					<tr>
						<td><b>Enter Employee's Salon Name</b></td>
			...
			<tr>
				<th colspan="2"><input type="submit" value="Add Employee" class="btn btn-success"/></th>
			</tr>
