...
<div class="login-form">    
    <form  method="post">
     ...
     <div class="text-center small">Don't have an account? <a href="/user/register"><span class="badge badge-danger" style="color:white;font-size:15px;">Sign Up</span></a></div>
</div>
