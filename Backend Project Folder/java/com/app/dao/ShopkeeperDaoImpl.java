...
public  class ShopkeeperDaoImpl implements IShopkeeperDao{
	...
	@Override
	public List<Employee> getEmployeeList(String ownerName) {
		//Shops s=getShopByShopName(shopName);
		Shops s=getShopByOwnerName(ownerName);
		String jpql = "select s from Employee s where shop_id=:sid";
		List<Employee> elist=new ArrayList<Employee>();
		elist=mgr.createQuery(jpql,Employee.class).setParameter("sid",s.getShopId()).getResultList();
		return elist;
