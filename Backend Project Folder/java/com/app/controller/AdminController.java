...
public class AdminController {
	...
	@PostMapping("/update")
	public String ProcessUpdateShopForm(@RequestParam String shopName,@RequestParam String ownerName,String addresses,
			String status,String locations,String areas,HttpSession hs,Model map)
	{
		System.out.println("in shop Update form");
